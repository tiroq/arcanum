...
func run() error {
	...
	logger.Info("starting source-sync", zap.Int("port", cfg.HTTP.Port))
	...
	logger.Info("shutting down source-sync")
	...
	logger.Info("source-sync stopped")
	return nil
}
